...
export default function TaskContentPage({ params }) {
    ...
    const fetchContentData = async (params = {}) => {
        ...
        try {
            ...
            const url = `http://127.0.0.1:8000/api/tasks/${unwrappedParams.id}/elastic-search${queryString ? `?${queryString}` : ''}`
                    ...
                    <Descriptions bordered column={1} size="middle">
                        <Descriptions.Item label="Content Category">
                            <a href={taskData.url} target="_blank" rel="noopener noreferrer">
                                {taskData.category} <ExportOutlined />
                            </a>
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item label="End Time">{formatDate(taskData.end_time)}</Descriptions.Item>
                        <Descriptions.Item label="Max Contents">{taskData.max_contents}</Descriptions.Item>
                        <Descriptions.Item label="Status">
                            <Tag color={taskData.is_active ? 'green' : 'volcano'}>
                                {taskData.is_active ? 'ACTIVE' : 'INACTIVE'}
                            </Tag>
                        </Descriptions.Item>
